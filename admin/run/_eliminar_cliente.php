 ...
 */
    ...
    if ($id == "") {
        echo "<span class='error'>¡ERROR! No se ha indicado el cliente</span>";
        return;
    }
    ...
    if (!$resultado) {
        echo "<span class='error'>¡ERROR! No se ha podido eliminar el cliente. Inténtalo de nuevo</span>";
        return;
    }
    
    echo "El Cliente ha sido eliminado con éxito";
?>
