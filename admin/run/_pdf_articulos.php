...
$cabeceras = array("Nombre", "Descripción", "Stock", "Precio Venta");
$columnas = array("nombre", "descripcion", "stock", "precio_venta");
$anchuras = array(45, 45, 25, 65);
$bbdd = new BBDD();
$resultado = $bbdd->ejecuta_consulta("SELECT * FROM articulos WHERE nombre LIKE '%" .
    $busqueda_rapida . "%' OR descripcion LIKE '%" . $busqueda_rapida . "%'");

$informe = new InformeListado();
$informe->crear("LISTADO DE ARTÍCULOS", $cabeceras, $columnas, $resultado, $anchuras);
